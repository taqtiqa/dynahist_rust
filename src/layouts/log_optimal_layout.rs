 ...
 * slower compared to [`LogLinearLayout`] and [`LogQuadraticLayout`].
 *
...
impl GuessLayout for LogOptimalLayout {
   ...
   /// @return a new [`LogOptimalLayout`] instance
   ///
   ...
   ///
    ...
    pub fn read( data_input: impl DataInput) -> Result<LogOptimalLayout, std::rc::Rc<DynaHistError>> {
