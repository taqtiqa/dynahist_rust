...
pub struct SeriateUtilTest {
}

impl SeriateUtilTest {

    #[test]
    fn test_read_unsigned_var_int(&self) {
         let array : vec![i8; 9] = vec![-1, -2, -3, -4, -5, -6, -7, -8, -9, ]
        ;
        assert_throws(IOError.class, () -> SeriateUtil::read_unsigned_var_int(DataInput::new(ByteArrayInput::new(&array))));
    }
    ...
    fn test_read_unsigned_var_long(&self) {
        ...
        ;
        assert_throws(IOError.class, () -> SeriateUtil::read_unsigned_var_long(DataInput::new(ByteArrayInput::new(&array))));
    }
    ...
    fn test_serialization(&self)  -> Result<(), std::rc::Rc<DynaHistError>> {
        ...
        histogram_static.add_ascending_sequence(|&i| { i + 1 }, 1000000000);
       {
            ...
            serialized_histogram = SeriateUtil::write(histogram_dynamic);
            compressed_histogram = SeriateUtil::write_compressed(histogram_dynamic);
            deserialized_histogram = SeriateUtil::read_as_dynamic(layout, &serialized_histogram);
            decompressed_histogram = SeriateUtil::read_compressed_as_dynamic(layout, &compressed_histogram);
        ...
        }
       {
             ...
             let decompressed_histogram: Histogram;
             let deserialized_histogram: Histogram;
            serialized_histogram = SeriateUtil::write(histogram_static);
            compressed_histogram = SeriateUtil::write_compressed(histogram_static);
            deserialized_histogram = SeriateUtil::read_as_static(layout, &serialized_histogram);
            decompressed_histogram = SeriateUtil::read_compressed_as_static(layout, &compressed_histogram);
        ...
        }
       {
             ...
             let decompressed_histogram: Histogram;
             let deserialized_histogram: Histogram;
            serialized_histogram = SeriateUtil::write(histogram_preprocessed);
            compressed_histogram = SeriateUtil::write_compressed(histogram_preprocessed);
            deserialized_histogram = SeriateUtil::read_as_preprocessed(layout, &serialized_histogram);
            decompressed_histogram = SeriateUtil::read_compressed_as_preprocessed(layout, &compressed_histogram);
    ...
    fn test_write_and_write_compressed(&self)  -> Result<(), std::rc::Rc<DynaHistError>> {
        ...
        histogram.add_ascending_sequence( |&i| { i + 1 }, 50);
         let serialized_histogram: Vec<i8> = SeriateUtil::write(histogram);
         let compressed_histogram: Vec<i8> = SeriateUtil::write_compressed(histogram);
    ...
    fn test_from_byte_array(&self)  -> Result<(), std::rc::Rc<DynaHistError>> {
        ...
        assert_eq!(histogram, &SeriateUtil::from_byte_array(serialization_reader, serialized_histogram));
    }
    ...
    fn test_to_byte_array(&self)  -> Result<(), std::rc::Rc<DynaHistError>> {
        ...
        assert_array_equals(&serialized_histogram, &SeriateUtil::to_byte_array(serialization_writer, histogram));
    }
}
