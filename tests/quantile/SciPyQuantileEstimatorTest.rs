...
// SPDX-License-Identifier: Apache-2.0 OR MIT
 ...
 const QUANTILE_ESTIMATORS: Collection<QuantileEstimation> = Arrays::as_list(&SciPyQuantileEstimator::create(0.5, 0.5), &SciPyQuantileEstimator::create(0.0, 0.5), &SciPyQuantileEstimator::create(0.5, 0.0), &SciPyQuantileEstimator::create(0.4, 0.3), &SciPyQuantileEstimator::create(0.5, 1), &SciPyQuantileEstimator::create(1, 0.5), &SciPyQuantileEstimator::create(1, 0.0), &SciPyQuantileEstimator::create(0.0, 1.0), &SciPyQuantileEstimator::create(1.0, 0.0), &SciPyQuantileEstimator::create(1, 1.0), &SciPyQuantileEstimator::create());
...
impl SciPyQuantileEstimatorTest {
    ...
    fn test(&self) {
        ...
        ;
        Arrays::sort(&values);
         let quantile_estimator: QuantileEstimation = SciPyQuantileEstimator::create(0.4, 0.4);
        assert_eq!(19.200000000000003, &quantile_estimator.estimate_quantile_from_values(0.25, &values), 0);
        assert_eq!(40, &quantile_estimator.estimate_quantile_from_values(0.5, &values), 0);
        assert_eq!(42.8, &quantile_estimator.estimate_quantile_from_values(0.75, &values), 0);
    }
    ...
    fn test2(&self) {
        ...
        Arrays::sort(&values);
         let quantile_estimator: QuantileEstimation = SciPyQuantileEstimator::create(0.4, 0.4);
        assert_eq!(3, &quantile_estimator.estimate_quantile_from_values(0, &values), 0);
        assert_eq!(3, &quantile_estimator.estimate_quantile_from_values(0.25, &values), 0);
        assert_eq!(4, &quantile_estimator.estimate_quantile_from_values(0.5, &values), 0);
        assert_eq!(5, &quantile_estimator.estimate_quantile_from_values(0.75, &values), 0);
        assert_eq!(5, &quantile_estimator.estimate_quantile_from_values(1, &values), 0);
    }
    ...
    fn test3(&self) {
        ...
        ;
        Arrays::sort(&values);
         let quantile_estimator: QuantileEstimation = SciPyQuantileEstimator::create(0.5, 0.5);
        assert_eq!(3, &quantile_estimator.estimate_quantile_from_values(0, &values), 0);
        assert_eq!(3, &quantile_estimator.estimate_quantile_from_values(0.25, &values), 0);
        assert_eq!(4, &quantile_estimator.estimate_quantile_from_values(0.5, &values), 0);
        assert_eq!(5, &quantile_estimator.estimate_quantile_from_values(0.75, &values), 0);
    ...
    #[test]
    fn test_sci_py_quantile_estimator_constructor(&self) {
